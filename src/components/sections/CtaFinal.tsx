...
export function CtaFinal() {
  return (
    <section className="relative py-20 md:py-28 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center glassmorphism px-5 py-10 sm:p-10 md:p-16 overflow-hidden">
        {/* Glow de Background */}
        ...
        <SectionTitle type="chars" className="font-sora font-extrabold text-[clamp(28px,5vw,56px)] leading-tight text-text-primary mb-6 relative z-10">
          {copy.cta.titulo}
        </SectionTitle>
